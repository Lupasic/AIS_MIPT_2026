...
\begin{frame}[t]{Concept: Exoskeleton for the Mind}
    ...
    \end{itemize}
    \begin{figure}[H]
        \centering\includegraphics[height=4cm,width=1\textwidth,keepaspectratio]{auf.jpeg}
            \vspace*{-0.3cm}
...
\begin{frame}[t]{The Isolation Problem}
    ...
    \begin{figure}[H]
        \centering\includegraphics[height=4.5cm,width=1\textwidth,keepaspectratio]{mcp.jpg}
...
\begin{frame}[t]{Best models}
    ...
    \begin{figure}[H]
        \href{https://youtu.be/_i9UhGnOZCM?si=0OMvlfdiMjg9agub}{
            \centering\includegraphics[height=6cm,width=1\textwidth,keepaspectratio]{best_vibe_coding.jpg}}
...
\begin{frame}[t]{Reference Materials}
    \begin{itemize}
        ...
        \item \href{https://www.youtube.com/watch?v=d4dPB8bJVMI}{Copilot now supports Skills}
        \item \href{https://youtu.be/fabAI1OKKww?si=5o7VOV6SzttDFLkp}{THe complete guide to Agent Skills}
    \end{itemize}
\end{frame}

\begin{frame}{}
\framesubtitle{}
    \LARGE \centering\textbf{Addition slides from Alexander Borodin about Skills}
\end{frame}

\usebackgroundtemplate{}
\setbeamercolor{background canvas}{bg=}
\includepdf[pages=-,fitpaper, linktodoc=true]{skills.pdf}
\fbckg{fibeamer/figs/common.png}
